...
// カードマスタデータ(docs/カードリスト_v1.md 準拠・全48種)
export const CARDS: Card[] = [
  ...
  { id: 'N03', name: '鬼火', type: 'monster', rarity: 'N', stars: 1, atk: 600, def: 100, effectText: '' },
  ...
  { id: 'N10', name: 'ぬりかべ', type: 'monster', rarity: 'N', stars: 2, atk: 100, def: 1200, effectText: '' },
  ...
  // ノーマル(N) 魔法・罠 7種
  { id: 'N19', name: '鬼退治', type: 'magic', rarity: 'N', effectText: '相手モンスター1体を破壊する。' },
  { id: 'N20', name: '草薙剣', type: 'magic', rarity: 'N', effectText: '自分のモンスター1体の攻撃力をターン終了時まで+500する。' },
  { id: 'N21', name: '払い清め', type: 'magic', rarity: 'N', effectText: '相手の伏せカード(魔法・罠)1枚を破壊する。' },
  { id: 'N22', name: '死者の声', type: 'magic', rarity: 'N', effectText: '自分の場にモンスターがいない場合のみ発動可能。自分の墓地からモンスター1体を、レベルを無視して守備表示で場に出す。' },
  ...
  { id: 'N25', name: '神隠し', type: 'trap', rarity: 'N', effectText: '相手の攻撃宣言時に発動。攻撃してきたモンスター1体を持ち主の手札に戻す。' },
  // レア(R) モンスター 8種
  ...
  { id: 'R04', name: '安倍晴明', type: 'monster', rarity: 'R', stars: 4, atk: 1300, def: 1000, effectText: '召喚時、自分のデッキから魔法・罠カード1枚を手札に加え、デッキをシャッフルする。' },
  ...
  { id: 'R11', name: '落とし穴', type: 'trap', rarity: 'R', effectText: '相手がモンスターを召喚した時に発動。そのモンスターを破壊する。' },
  { id: 'R12', name: '背水の陣', type: 'trap', rarity: 'R', effectText: '自分の場にモンスターがいない時、相手の攻撃宣言時に発動。手札からモンスター1体をレベルを無視して場に出す。攻撃はそのモンスターに向かう。' },
  // スーパーレア(SR) モンスター 5種
  ...
  { id: 'SR5', name: 'ヴァルキリー', type: 'monster', rarity: 'SR', stars: 7, atk: 2200, def: 1800, effectText: '召喚時、自分の墓地から★3以下のモンスター1体を場に出せる。' },
  // スーパーレア(SR) 魔法・罠 3種
  { id: 'SR6', name: '天罰', type: 'magic', rarity: 'SR', effectText: '相手の場のモンスターを全て破壊する。' },
  { id: 'SR7', name: '黄泉返り', type: 'magic', rarity: 'SR', effectText: '自分の墓地からモンスター1体を、レベルを無視して場に出す。' },
  { id: 'SR8', name: 'アイギスの盾', type: 'trap', rarity: 'SR', effectText: '相手の攻撃宣言時に発動。相手の場の攻撃表示モンスターを全て破壊する。' },
  // ウルトラレア(UR) 3種
