...
// カードマスタデータ(docs/カードリスト_v1.5.2.md 準拠・全53種)
export const CARDS: Card[] = [
  ...
  { id: 'N04', name: '豆狸', type: 'monster', rarity: 'N', stars: 1, atk: 200, def: 600, effectText: '召喚のリリースとして、手札からリリースできる。', handReleasable: true },
  ...
  { id: 'N08', name: '人魚姫', type: 'monster', rarity: 'N', stars: 2, atk: 700, def: 800, effectText: '召喚のリリースとして、手札からリリースできる。', handReleasable: true },
  ...
  { id: 'N26', name: '化け狸', type: 'monster', rarity: 'N', stars: 2, atk: 500, def: 500, effectText: 'リリースする場合、星3として扱える。', releaseStarRange: { min: 1, max: 3 } },
  ...
  { id: 'N16', name: '一反木綿', type: 'monster', rarity: 'N', stars: 3, atk: 1100, def: 600, effectText: '召喚のリリースとして、手札からリリースできる。', handReleasable: true },
  ...
  { id: 'R13', name: '鵺', type: 'monster', rarity: 'R', stars: 4, atk: 1200, def: 1000, effectText: 'リリースする場合、星5として扱える。', releaseStarRange: { min: 1, max: 5 } },
